...
leResult screenShow_Screen0(void)
{
    ...
    Screen0_mhgsLogo->fn->setPosition(Screen0_mhgsLogo, 319, 170);
    Screen0_mhgsLogo->fn->setSize(Screen0_mhgsLogo, 80, 75);
    ...
    Screen0_mhgsLogo->fn->setImage(Screen0_mhgsLogo, (leImage*)&small_panda);
    ...
    Screen0_qsButton->fn->setPosition(Screen0_qsButton, 267, 16);
    ...
    Screen0_ImageWidget_0->fn->setPosition(Screen0_ImageWidget_0, 40, 81);
    Screen0_ImageWidget_0->fn->setSize(Screen0_ImageWidget_0, 158, 113);
    Screen0_ImageWidget_0->fn->setBorderType(Screen0_ImageWidget_0, LE_WIDGET_BORDER_NONE);
    Screen0_ImageWidget_0->fn->setImage(Screen0_ImageWidget_0, (leImage*)&panda_scaled);
